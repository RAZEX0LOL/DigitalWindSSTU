...
export default function HeaderUser({ handleWorksClick, handleLoginChangeClick, handleAddWorkClick }) {
        ...
        <header>
            ...
            <nav>
                ...
                <div className="header_nav_info">
                    <p className="header__nav" onClick={handleWorksClick}>Мои работы</p>
                    <p className="header__nav" onClick={handleAddWorkClick}>Добавить работу</p>
